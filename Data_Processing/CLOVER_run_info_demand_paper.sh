...
echo 'Name,Growth,Climate,Accessibility,PV_y0_kW,PV_y5_kW,StoPerPV_y0,StoPerPV_y5,LCUE,Capex,EmIntens,Sto_y0,Sto_y5' > /Users/Shez/Google\ Drive/Grantham/ElDemAcc/Outputs/CLOVER_run_info_summarised.csv
...
do
	...
	Stor_per_PV_first=$(echo "${Stor_size_first}/${PV_size_first}" | bc -l)
	Stor_per_PV_last=$(echo "${Stor_size_last}/${PV_size_last}" | bc -l)
	...
	echo "${name},${growth},${climate},${accessibility},${PV_size_first},${PV_size_last},${Stor_per_PV_first},${Stor_per_PV_last},${LCUE},${Initial_capital},${Em_intens},${Stor_size_first},${Stor_size_last}" >> /Users/Shez/Google\ Drive/Grantham/ElDemAcc/Outputs/CLOVER_run_info_summarised.csv

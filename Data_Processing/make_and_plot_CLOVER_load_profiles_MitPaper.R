...
dir.create(paste(output_path,'CLOVER_Loads/'), showWarnings = FALSE)
dir.create(paste(plot_path,'Final_Year/'), showWarnings = FALSE)
dir.create(paste(plot_path,'S_Curves/'), showWarnings = FALSE)
